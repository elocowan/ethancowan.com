...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <h3>My timeline</h3>
      <p>I was born in Sunnyvale, CA in 1985. My father worked as a systems administrator for a computer company and my mother had her commercial interior design firm. We moved to Boulder, CO in 1995 because my Mother grew up here, and my parents were burnt out by the work culture of Silicon Valley. As a young person, I was passionate about gymnastics, skateboarding and jazz.</p>
